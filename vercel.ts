...
// must revalidate so a deploy reaches learners. Every other path falls back to the app (deep
// links) except /assets/, where a missing file is a 404 rather than the app under a year's cache.
